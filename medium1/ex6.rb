...
MULT at this point, then the stack is transformed to 3, and the register is
...
def minilang(str)
  ...
  str.split.each do |word|
    case word
    when word.to_i.to_s # LS solution used this as the else statememt instead of explicit like I have
      register = word.to_i
    when 'PUSH'
      stack << register
    when 'ADD'
