...
Problem:
- Input: Array (with unique elements except one duplicate)
- Output: Integer (the duplicate one)


Algorithm:
- Iterate through the elements in the given Array
  - For each element, count the number of that element in the given Array
...
### Vincent solution (from comments)
def find_dup(array)
