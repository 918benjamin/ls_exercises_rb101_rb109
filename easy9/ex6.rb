...
- input: string
- output: return Array
  - each element is a word from the string + space + word length
- one space separates each word

Algorithm
- Split the string into an array of words
- iterate through the array transforming each word (map)
  - add a space and the length of the word
