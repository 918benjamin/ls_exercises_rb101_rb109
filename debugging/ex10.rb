...
Answer: Within the idf method, the Math.log is passed the integer result of the division argument.
We need to coerce one of those values to a float before performing the division and passing them into the log method.
