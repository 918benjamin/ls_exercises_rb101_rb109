...
# The problem is that on line 5 (original, line 16 below), odd_count is
# reassigned to 3 instead of checked for equivalence with three.
...
## Nope! We can safely remove it in this case.
